...
<main>
    <section id="presentacion">
        <div class="img_dog_container">
            <img src="<%=request.getContextPath()%>/assets/img/home/Rectangle_4222.png" class="img-fluid" alt="perro"
                 style="width: 400px;">
        </div>
    ...
    <section id="fotos">
        <div class="container text-center">
            <div class="row align-items-start no-gutters">
                ...
                <div class="col">
                    <img src="<%=request.getContextPath()%>/assets/img/home/Rectangle 4227.png" class="img-fluid"
                         alt="perro1">
                </div>
                <div class="col">
                    <img src="<%=request.getContextPath()%>/assets/img/home/Rectangle 4228.png" class="img-fluid"
                         alt="perro2">
                </div>
            </div>
        </div>
    ...
    <section id="mapa">
        ...
        <div class="img_map">
            ...
            <img src="<%=request.getContextPath()%>/assets/img/home/Group 2.png" class="img-fluid" alt="perro"
                 style="width: 600px;">
